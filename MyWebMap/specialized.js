window.onload = function() {
    ...
    src = "specializedData_phase1.js"; // added by Dr. Yang
    src = "specializedData_phase2.js";
    src = "specializedData_phase-3-4.js";
    ...
    info.update = function(props) {
        ...
        this._div.innerHTML = `<h4>Percent of Ritual Objects - Ritual Paraphernalia</h4>${contents}`; // edited by Sarigai // same correction here
    };
    info.addTo(map);
   ...
   {const geojson = L.geoJson(specializedData_phase1, {
        style,
        onEachFeature,
    }).addTo(map);
    ...
    {const geojson = L.geoJson(specializedData_phase2, {
        style,
        onEachFeature,
    }).addTo(map);
    ...
    {const geojson = L.geoJson(specializedData_phase3_4, {
        style,
        onEachFeature,
    }).addTo(map);
