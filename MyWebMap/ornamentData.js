window.onload = function() {
    ...
    src = "ornamentData_phase1.js"; // added by Dr. Yang
    src = "ornamentData_phase2.js";
    src = "ornamentData_phase-3-4.js";
    ...
    info.update = function(props) {
        ...
        this._div.innerHTML = `<h4>Percent of Ritual Objects - Ornaments</h4>${contents}`; // edited by Sarigai // same correction here
    };
    info.addTo(map);
   ...
   {const geojson = L.geoJson(ornamentData_phase1, {
        style,
        onEachFeature,
    }).addTo(map);
    ...
    {const geojson = L.geoJson(ornamentData_phase2, {
        style,
        onEachFeature,
    }).addTo(map);
    ...
    {const geojson = L.geoJson(ornamentData_phase3_4, {
        style,
        onEachFeature,
    }).addTo(map);
