window.onload = function() {
    ...
    src = "faunaData_phase1.js"; // added by Dr. Yang
    src = "faunaData_phase2.js";
    src = "faunaDate_phase-3-4.js";
    ...
    info.update = function(props) {
        ...
        this._div.innerHTML = `<h4>Percent of Ritual Objects - Fauna</h4>${contents}`; // edited by Sarigai // same correction here
    };
    info.addTo(map);
   ...
   {const geojson = L.geoJson(faunaData_phase1, {
        style,
        onEachFeature,
    }).addTo(map);
    ...
    {const geojson = L.geoJson(faunaData_phase2, {
        style,
        onEachFeature,
    }).addTo(map);
    ...
    {const geojson = L.geoJson(faunaData_phase3_4, {
        style,
        onEachFeature,
    }).addTo(map);
